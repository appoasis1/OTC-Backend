<template>
                             ...
                             <div class="field mb-4 col-12 md:col-12"> 
                                 ...
                                 <DataTable :value="users" showGridlines tableStyle="min-width: 50rem">
                                     ...
                                     <Column header="Actions">
                                         <template #body="slotProps">
                                             <Button @click="deleteUser(slotProps.data.id)" icon="pi pi-trash" outlined rounded class="mr-2"/>
                                         </template>
                                     </Column>
                                 </DataTable>
                             </div>
 ...
 const user_type = ref(["Admin","Accountant"])
...
onMounted(async()=>{
  let result = await adminStore.getUsers()
})

 const deleteUser = async () =>{
    let result = await adminStore.getUser()
 }
