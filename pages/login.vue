    ...
    <NuxtLayout name="authentication">
        ...
        <div class="block-content">
            ...
            <div class="surface-card shadow-2 border-round  lg:w-6 w-full lg:w-6 p-4 lg:p-7">
                ...
                <div class="text-center mb-5"> <img src="/images/murare.png" alt="Image" height="100" width="200" class="mb-3">

                    <div class="text-900 text-3xl font-medium mb-3">Murare Sales Invoice System</div>
